...
export default function AuthErrorPage({ searchParams }) {
  const error = searchParams?.error || 'An unknown authentication error occurred';
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-sm text-gray-400 text-center">
              Need help? Check that you have granted the necessary permissions to the application.
            </p>
          </div>
        </div>
      </div>
