...
// Template management
export { TemplateRegistry, createTemplateRegistry, DEFAULT_TEMPLATE_REPOSITORIES } from './template-registry.js';
export { TemplateService, createTemplateService } from './template-service.js';
